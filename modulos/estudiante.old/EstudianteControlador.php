...
class EstudianteControlador
{
	...
	public static function listar()
	{
		try
		{
			...
			$estudiante=EstudianteServicio::listar(null,null,null,null,$codPersona);

			$personas=EstudianteServicio::listarPersonaEstudiante($pnf,$estado,$instituto,null,null,null,null,'q');
	...
	public static function agregar()
	{
		try
		{
			...
			if(!$codigo)
				EstudianteServicio::agregar($codPersona, 	$codInstituto, 	$codPensum,
				...
				EstudianteServicio::modificar($codigo,		$codPersona, 	$codInstituto, 	$codPensum,
											$numCarnet, 	$numExpediente,	$codRusnies,
											$codEstado,		$fecInicio, 	$fecFin,
											$condicion, 	$observaciones
										);
	...
	public static function eliminar ()
	{
		try
		{
			...
			EstudianteServicio::eliminar($codigo);
