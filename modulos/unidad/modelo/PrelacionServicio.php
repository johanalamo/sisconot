...
class PrelacionServicio
{
	...
	/**
		...
		try{
			...
			$ejecutar->bindParam(':cod_pensum',$prelacion->obtenerNombre(), PDO::PARAM_INT);
			$ejecutar->bindParam(':cod_instituto',$prelacion->obtenerNombreCorto(), PDO::PARAM_INT);
			$ejecutar->bindParam(':cod_uni_curricular',$prelacion->obtenerObservaciones(), PDO::PARAM_INT);
			$ejecutar->bindParam(':cod_uni_cur_prelada',$prelacion->obtenerMinCanElectiva(), PDO::PARAM_INT);
