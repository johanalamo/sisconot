...
/* el estandar es al final de la función colocar los siguientes sufijos ****************************************
 *     ins  .... insertar
 *     eli  .... eliminar
 *     act  .... actualizar
 *     sel  .... seleccionar
 * 
 * 
 * es decir la funciòn f_empleado_listar deberia llamarse f_impleado_sel
   y la función f_empleado_lis_cod deberia llamarse f_empleado_sel_por_codigo
...
resultados de la revisión
	Insersión es con C, es decir: inserción.

	el parámetro es_docente colócalo como p_es_docente.
	vamos a trabajar un poco más indentado los sql, ve el de la función
	siguiente: un campo por linea para poder hacerle mantenimiento de 
	una manera más fácil, tal cual cómo lo haces con los parámtros de la
	función.
*/ 
...
/****************************************************************
Esta función aplicale lo mismo que la anterior, mejora la indentación
de la consulta sql
*/ 
...
BEGIN
	...
	SET 
		...
		fec_fin=p_fec_fin,
		es_jef_pensum=p_es_jef_pensum,
		es_jef_con_estudio=p_es_jef_con_estudio,
		es_ministerio=p_es_ministerio,
 ...
 * 
 * Parámetros de entrada:
		p_codigo:             atención aqui.....           DESCRIBE LOS PARÁMETROS ***************************************
 *		
 *		
 */
