/*************corrección...... falta la función eliminar  */
...
/*REVISION:... debes indentar las consultas con un campo por linea, esto es para facilitar el mantenimiento
_**************************************************************************************************************
 ver la correcciòn de empleado para que te guíes
*/	
...
*/	
	...
	SET 
		cedula=p_cedula,
		rif=p_rif,
		nombre1=p_nombre1,nombre2=p_nombre2,apellido1=p_apellido1,apellido2=p_apellido2,sexo=p_sexo,
