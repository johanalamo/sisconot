		...
		<div class="row-fluid">
				<div class="col-md-10 col-md-offset-1">		
					<div class="input-group">									
							...
							<input type='text' name='min_cant_elect' onkeyup="validarSoloNumeros('#min_cant_elect',1,2,true)" id='min_cant_elect'  class='form-control'  placeholder='Min cantidad electiva'>
						</div>
					</div>
		</div><br><br>
		<div class="row-fluid">
				<div class="col-md-10 col-md-offset-1">		
					<div class="input-group">									
							...
							<input type='text' name='min_cre_elect' onkeyup="validarSoloNumeros('#min_cre_elect',1,2,true)" id='min_cre_elect' class='form-control'  placeholder='Min credito obligatorio'>
						</div>
					</div>
		</div><br><br>
		<div class="row-fluid">
				<div class="col-md-10 col-md-offset-1">		
					<div class="input-group">									
							...
							<input type='text' name='min_cre_oblig'  onkeyup="validarSoloNumeros('#min_cre_oblig',1,3,true)" id='min_cre_oblig' class='form-control'  placeholder='Min credito obligatorio'>
						</div>
					</div>
		</div><br><br>
		<div class="row-fluid">
